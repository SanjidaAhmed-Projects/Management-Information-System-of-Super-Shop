...
public class CosmeticsJFrame extends javax.swing.JFrame {

    Connection conn=null;
    ResultSet rs = null;
    PreparedStatement pst=null;
    public CosmeticsJFrame() {
        initComponents();
    ...
    private void Fill_Combo()
    {
        try
        {
            String sql="Select * from Product_cosmetics";
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Product(Accessories) Informations", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 14), new java.awt.Color(0, 102, 0))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String sql = "Insert into Product_cosmetics (ID,Name,Price,Date,Image) values (?,?,?,?,?)";
        try
        {
            pst=conn.prepareStatement(sql);
    ...
    private void tbl_foodsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_foodsMouseClicked
        ...
        try
        {
            String sql = "Select Image from Product_cosmetics where ID='"+Table_Click+"'";
            pst=conn.prepareStatement(sql);
            rs=pst.executeQuery();
            if(rs.next())
            {
...
txt_imgpath.setText(filename);
        ...
        try
        {
            ...
            String sql = "Select * from Product_cosmetics where ID='"+Table_Click+"' ";
            pst=conn.prepareStatement(sql);
            rs=pst.executeQuery();
            if(rs.next())
            {
...
txt_imgpath.setText(filename);
    ...
    private void txt_searchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_searchKeyReleased
        try
        {
            String sql = "Select * from Product_cosmetics where ID=?";
            pst=conn.prepareStatement(sql);
...
txt_imgpath.setText(filename);
        ...
        try
        {
            String sql = "Select * from Product_cosmetics where Name=?";
            pst=conn.prepareStatement(sql);
            pst.setString(1, txt_search.getText());
            rs=pst.executeQuery();
            if(rs.next())
...
txt_imgpath.setText(filename);
    ...
    private void btn_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_updateActionPerformed
        try
        {
            ...
            String sql = "Update Product_cosmetics set ID='"+value1+"',Name='"+value2+"',Price='"+value3+"',Date='"+value4+"',Image='"+value5+"' where ID='"+value1+"' ";
            pst=conn.prepareStatement(sql);
            pst.execute();
    ...
    private void btn_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deleteActionPerformed
        ...
        if(p==0)
        {
            String sql = "Delete from Product_cosmetics where ID=?";
            try
            {
                pst=conn.prepareStatement(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CosmeticsJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CosmeticsJFrame().setVisible(true);
            }
        });
    }
